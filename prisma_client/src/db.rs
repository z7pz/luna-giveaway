...
pub mod giveaway {
    ...
    pub fn create(
        ...
        (
            message_id, channel_id, prize, start_at, end_at, winners, guild, _params,
        )
    }
    pub fn create_unchecked(
        message_id: i64,
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_giveaway { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: giveaway struct $ struct_name { # [serde (rename = "message_id")] pub message_id : i64 , # [serde (rename = "guild_id")] pub guild_id : i64 , # [serde (rename = "channel_id")] pub channel_id : i64 , # [serde (rename = "prize")] pub prize : String , # [serde (rename = "start_at")] pub start_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "end_at")] pub end_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "winners")] pub winners : i32 , # [serde (rename = "is_ended")] pub is_ended : bool , # [serde (rename = "created_at")] pub created_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "updated_at")] pub updated_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > } [$ ($ scalar_field) , +] } } ; }
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (message_id, channel_id, prize, start_at, end_at, winners, guild, mut _params): (
                i64,
                i64,
                String,
                ::prisma_client_rust::chrono::DateTime<::prisma_client_rust::chrono::FixedOffset>,
